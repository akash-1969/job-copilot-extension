 ...
 */
function calculateFullMatch(jobDetailsData, userProfile, aiAnalysisOverride = null) {
  ...
  // 1. Invoke Pluggable Job Understanding Layer or use AI override
  let analysis;
  if (aiAnalysisOverride) {
    analysis = aiAnalysisOverride;
  } else {
    ...
    analysis = understandingLayer.analyzeJob(jobDetailsData);
  }
  const explicitReq = analysis.extractedSkills || [];
  const inferredReq = analysis.inferredSkills || [];
